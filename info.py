...
URL = "https://hahsj-32c2a181122f.herokuapp.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://hahsj-32c2a181122f.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://fillter5789-85e856fb2141.herokuapp.com/".format(FQDN)
else:
    URL = "https://fillter5789-85e856fb2141.herokuapp.com/".format(FQDN)
